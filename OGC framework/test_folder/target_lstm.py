...
class TargetLSTM(nn.Module):
    ...
    def __init__(self,  vocab_size, embedding_dim, hidden_dim, use_cuda,is_bid=False,num_layer=1):
        super(TargetLSTM, self).__init__()
        self.hidden_dim = hidden_dim
        self.use_cuda = use_cuda
        self.embed = nn.Embedding(vocab_size, embedding_dim)
        self.lstm = nn.LSTM(embedding_dim, hidden_dim, num_layers=num_layer,batch_first=True,bidirectional=is_bid)
